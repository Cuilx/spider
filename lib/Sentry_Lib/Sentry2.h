...
#define SENTRY2_DEVICE_ID 0x04
  ...
  public:
     ...
     *         other:  error
     */
    uint8_t VisionBegin(uint8_t vision_type)
    {
     ...
     *         other:  error
     */
    uint8_t VisionEnd(uint8_t vision_type)
    {
     ...
     *         other:  error
     */
    uint8_t SetParamNum(uint8_t vision_type, int max_num)
    {
     ...
     *         other:  error
     */
    uint8_t SetParam(uint8_t vision_type, sentry_object_t *param,
                     int param_id = 1)
    {
     ...
     */
    int GetValue(uint8_t vision_type, sentry_obj_info_e obj_info,
                 int obj_id = 1)
    {
      return SentryFactory::GetValue((int)vision_type, obj_info, obj_id);
    }

    bool VisionGetStatus(uint8_t vision_type)
    {
      return SentryFactory::VisionGetStatus((int)vision_type);
    }

    uint8_t VisionSetDefault(uint8_t vision_type)
    {
      return SentryFactory::VisionSetDefault((int)vision_type);
    }

    uint8_t UpdateResult(uint8_t vision_type)
    {
